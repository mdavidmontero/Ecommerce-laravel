<x-admin-layout :breadcrumbs="[
    ...
    <ul class="space-y-4" id="covers">
        @foreach ($covers as $cover)
            <li class="overflow-hidden bg-white rounded-lg shadow-lg cursor-move lg:flex" data-id="{{ $cover->id }}">
                <img src="{{ $cover->image }}" alt=""
                    class="w-full lg:w-64 aspect-[3/1] object-cover object-center" />
                <div class="p-4 space-y-2 lg:flex lg:items-center lg:justify-between lg:flex-1 lg:space-y-0">
                    <div>
