...
class ProductsVariants extends Component
{
    public $product;
    ...
    {
        $feautures = $this->product->options->pluck('pivot.features');
        $combinaciones = $this->generarCombinaciones($feautures);
    ...
    {
        return view('livewire.admin.products.products-variants');
    }
}
